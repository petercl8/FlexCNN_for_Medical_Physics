...
"""# Install Required Packages & Setup Environment"""

import os, sys, glob, importlib, inspect, types, subprocess, pkgutil
from script_setup import (
    sense_colab, sense_device, install_packages, reload_submodules,
    resolve_repo_root, setup_colab_environment, setup_local_environment,
    refresh_repo
)
...
if IN_COLAB:
    ...
    setup_local_environment(repo_name=repo_name, mode=setup_mode_type, base_repo_path=base_repo_path)
