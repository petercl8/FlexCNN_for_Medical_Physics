...
from working.tuned_config_dicts.tuned_ACT_SI import config_ACT_SI
...
def build_all_dicts(params):
    ...
    common_settings = {
        ...
        'frozen_features_drop_max_prob': params.get('frozen_features_drop_max_prob'),
        'frozen_features_drop_min_prob': params.get('frozen_features_drop_min_prob'),
    ...
    data_files = {
        ...
        'tune_val_act_recon1_file': params['tune_val_act_recon1_file'],
        'tune_val_act_recon2_file': params['tune_val_act_recon2_file'],
        ...
        'train_val_act_recon1_file': params['train_val_act_recon1_file'],
        'train_val_act_recon2_file': params['train_val_act_recon2_file'],
    ...
    network_opts = {
        ...
        'frozen_variant': params['frozen_variant'],
        'gen_image_size': params['gen_image_size'],
        'gen_sino_size': params['gen_sino_size'],
        'gen_image_channels': params['gen_image_channels'],
        'gen_sino_channels_SI': params['gen_sino_channels_SI'],
        'gen_sino_channels_IS': params['gen_sino_channels_IS'],
