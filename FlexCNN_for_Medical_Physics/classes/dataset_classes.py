...
def NpArrayDataLoader(image_array, sino_array, config, augment=False, resize_type='CropPad', sino_pad_type='zeros', index=0, device='cuda', recon1_array=None, recon2_array=None, recon1_scale=1.0, recon2_scale=1.0):
