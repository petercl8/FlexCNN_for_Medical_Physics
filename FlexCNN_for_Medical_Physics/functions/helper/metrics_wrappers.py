...
def reconstruct_images_and_update_test_dataframe(sino_tensor, CNN_output, ground_image, test_dataframe, config, compute_MLEM=False):
    ...
    config:         configuration dictionary containing image_size, SI_normalize, SI_scale_fixed
    ...
    # Construct Outputs #
    FBP_output = reconstruct(sino_tensor, config['image_size'], config['SI_normalize'], config['SI_scale_fixed'], recon_type='FBP')
    if compute_MLEM==True:
        MLEM_output = reconstruct(sino_tensor, config['image_size'], config['SI_normalize'], config['SI_scale_fixed'], recon_type='MLEM')
