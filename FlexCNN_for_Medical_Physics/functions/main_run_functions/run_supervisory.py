...
def run_SUP(config, paths, settings):
    ...
    scale = config['SI_scale_fixed'] if train_SI else config['IS_scale']
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        for sino_ground, sino_ground_scaled, image_ground, image_ground_scaled in iter(dataloader):
            ...
            if run_mode == 'visualize':
                FBP_output = reconstruct(input_, config['image_size'], config['SI_normalize'], config['SI_scale_fixed'], recon_type='FBP')
                MLEM_output = reconstruct(input_, config['image_size'], config['SI_normalize'], config['SI_scale_fixed'], recon_type='MLEM')
